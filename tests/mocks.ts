...
export const RESPONSE_SOURCE1: Discovery = {
  flights: [
    {
      slices: [
        {
...
export const RESPONSE_SOURCE2: Discovery = {
  flights: [
    {
      slices: [
        {
...
export const RESPONSES_MERGED: Discovery = {
  flights: [
    {
      slices: [
        {
...
export const fetchMockAll = () => {
  fetchMock.mockIf(/.*/, (req) => new Promise((response, reject) => {
    if (req.url.endsWith('/source1')) {
      response(JSON.stringify(RESPONSE_SOURCE1));
    }
    if (req.url.endsWith('/source2')) {
      response(JSON.stringify(RESPONSE_SOURCE2));
    }
